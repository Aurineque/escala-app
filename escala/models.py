...
class Evento(models.Model):
    ...
    vagas_midia = models.IntegerField(
        default=2, help_text='Quantas pessoas precisam servir neste dia?'
    )
...
class Escala(models.Model):
    ...
    funcao = models.CharField(max_length=20, choices=Membro.FUNCOES, default='geral')
